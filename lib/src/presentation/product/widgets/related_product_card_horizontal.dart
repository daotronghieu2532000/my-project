...
class RelatedProductCardHorizontal extends StatelessWidget {
  final RelatedProduct product;

  const RelatedProductCardHorizontal({
    super.key,
                        ...
                        if (product.discountPercent > 0)
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: product.isFlashSale ? Colors.orange : Colors.red,
                                borderRadius: BorderRadius.circular(4),
                              ),
                              child: Text(
                                product.isFlashSale ? 'SALE' : '${product.discountPercent}%',
